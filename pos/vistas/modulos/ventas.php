...
if($xml){
  echo' <div class="btn btn-block btn-success">SE HA CREADO CORRECTAMENTE EL ARCHIVO XML</div> ';
}
                 ...
                 // }
                  ...
                  <td>
                    ...
                    <div class="btn-group">
                      ...
                      <button class="btn btn-info btnImprimirFactura" comprobanteT="'.$value["id_tipoComprobante"].'" codigoVenta="'.$value["codigo"].'">
